...
taxa_explanations <- list(
  ...
  "Akkermansia muciniphila" = "Akkermansia muciniphila is a bacterium within the Verrucomicrobia phylum, known for its role in maintaining gut health. It thrives on mucin, a key component of the mucus layer that protects the gut lining, helping to support gut barrier integrity. Higher levels of A. muciniphila have been linked to improved metabolism, better insulin sensitivity, and lower body fat. It also plays a role in reducing inflammation and may help prevent gut permeability issues like leaky gut.",
